...
def find_face(image_path, database, model, threshold):
...
def recognizeFace(image_path, threshold=0.6):
...
def main():
    ...
    while(ch == 'y' or ch == 'Y'):
        ...
        if user_input == '1':
            ...
            do_face_recognition(user_db, FRmodel, threshold=threshold, save_loc=img_path)
